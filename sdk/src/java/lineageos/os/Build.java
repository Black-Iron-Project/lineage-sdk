...
public class Build {
    ...
    public static final String BLACKIRONVERSION = getString("ro.blackiron.version");

    /** A build ID string meant for displaying to the user */
    public static final String BLACKIRONDISPLAY_VERSION = getString("ro.blackiron.display.version");
