...
public class Build {
    ...
    public static final String BLACKIRON_VERSION = getString("ro.blackiron.version");

    /** A build ID string meant for displaying to the user */
    public static final String BLACKIRON_DISPLAY_VERSION = getString("ro.blackiron.display.version");
